const products = [
    { id: 1, title: "ellery x m'o capsule", price: 2000 },
    { id: 2, title: "ellery x m'o capsule", price: 20 },
    { id: 3, title: "ellery x m'o capsule", price: 200 },
    { id: 4, title: "ellery x m'o capsule", price: 50 },
];
//Функция для формирования верстки каждого товара
const renderProduct = (title, price) => {
    return ` <div class="product__item">
    <ul class="product__list-grid">
        <li class="product__card">
            <div class="product__overlay">
                <img src="img/item-1.jpg" alt="item_1">
                <button class="product__button" type="button">
                    <div><svg width="27" height="25" viewBox="0 0 27 25" fill="none"
